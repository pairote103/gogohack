<html lang="th">
 <head>
  ...
  <meta property="og:title" content="|| SHOP.<?php echo $config['name']; ?> - ร้านขายของ ||">
  <meta property="og:type" content="website">
  <meta property="og:image" content="<?php echo $config['icon']; ?>">
  <meta property="og:url" content="<?php echo $config['www']; ?>">
  <meta property="og:description" content="เว็บขายไอดีแท้มายคราฟ">
  ...
  <body>
		<div class="container col-5" style="margin-top:70px;">
			  <div class="border border-secondary" style="margin-top:40px; margin-bottom: 50px; ">
			 <div class="card-header border-secondary" style="background: rgba(243, 243, 243,0.98)!important">
			 <div class="row">
			 <div class="col-4"> <h2 style="margin-top:3px;"><i class="fas fa-home"></i>&nbsp;<?php echo $config['name']; ?></h2></div>
			 <div class="col-8">
			   ...
			   <div class="text-left mt-1"><i class="fa fa-angle-right"></i> รหัสผ่าน</div>
				...
				<div class="input-group" style="margin-bottom: 10px;">
				<input class="form-control" style="height: 40px;" name="repassword" id="repassword" type="password" placeholder="Password Confirm" required="">
				</div>
				...
				<input class="form-control" style="height: 40px;margin-top: 7px;" name="captcha" id="captcha" type="text" placeholder="Captcha" required="">
					...
					<br>
					<br>
						<a class="btn btn-primary btn-block" id="btn" href="javascript:register();"><i class="fas fa-sign-in-alt"></i> สมัครสมาชิก</a>
						<a class="btn btn-warning" style="margin-top:20px" href="?page=home"><i class="fas fa-home"></i> หน้าแรก</a>
						<hr>
